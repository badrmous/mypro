...
export class PersonneListComponent implements OnInit , AfterViewInit {
  displayedColumns: string[] = ['id', 'nom', 'prenom', 'date_naissance' , 'action'];
    ...
    this.subscriptions.push(
      this.personneService.getAll().subscribe(
        data =>{
          ...
          this.dataSource.data = this.listPersonne;
        }
      )
    )
  }
